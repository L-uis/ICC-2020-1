...
public class SVG {
    ...
    public void agregarLinea(Linea linea) {
        // Implementar
        String s = "<line x1=\""+(linea.getP1()).getX()+"\" y1=\""+(altura-(linea.getP1()).getY())+"\" x2=\""+(linea.getP2()).getX()+"\" y2=\""+(altura-(linea.getP2()).getY())+"\" style=\"stroke:black;stroke-width:1;fill:none\"/>" ;
        concatenar(s);
    }
    ...
    public void agregarTriangulo(Triangulo triangulo) {
        // Implementar
        Linea ba = new Linea(triangulo.getVerticeB(),triangulo.getVerticeA());
        Linea ac = new Linea(triangulo.getVerticeA(),triangulo.getVerticeC());
        Linea cb = new Linea(triangulo.getVerticeC(),triangulo.getVerticeB());
